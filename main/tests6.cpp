...
bool test39_mesh_from_vsgf()
{
  ...
  hrRenderOpen(renderRef, HR_WRITE_DISCARD);
  {
    ...
    node.append_child(L"method_secondary").text() = L"pathtracing"; // L"pathtracing"; // L"lighttracing";
    node.append_child(L"method_tertiary").text()  = L"pathtracing"; // L"pathtracing"; // L"lighttracing";
    node.append_child(L"method_caustic").text()   = L"pathtracing"; // L"pathtracing"; // L"lighttracing";
    node.append_child(L"shadows").text()          = L"1";
