...
bool test90_check_xml_fail_lights()
{
	...
	hrSceneLibraryOpen(L"tests_f/test_90", HR_WRITE_DISCARD);
	...
	hrLightOpen(spot1, HR_WRITE_DISCARD);
	{
		...
		lightNode.attribute(L"shape").set_value(L"area");                                       // error introduced here
	...
	hrLightOpen(spot2, HR_WRITE_DISCARD);
	{
		...
		lightNode.append_child(L"fuckoff_angle").append_attribute(L"val").set_value(90);         // error introduced here
		lightNode.append_child(L"fuckoff_angle2").append_attribute(L"val").set_value(60);        // error introduced here
	...
	hrLightOpen(spot3, HR_WRITE_DISCARD);
	{
		...
		lightNode.append_child(L"falloff_angle2").text() = 75;                                  // error introduced here
...
bool test91_check_xml_fail_lights()
{
	...
	hrSceneLibraryOpen(L"tests_f/test_91", HR_WRITE_DISCARD);
	...
	hrLightOpen(spot1, HR_WRITE_DISCARD);
	{
		...
		// auto intensityNode = lightNode.append_child(L"intensity");     // error introduced here
		// 
		// intensityNode.append_child(L"color").append_attribute(L"val").set_value(L"1 0.5 1");
		// intensityNode.append_child(L"multiplier").append_attribute(L"val").set_value(L"8.0");
	...
	hrLightOpen(spot2, HR_WRITE_DISCARD);
	{
		...
		intensityNode.append_child(L"color").append_attribute(L"val").set_value(L"0.5, 1, 0.5");          // error introduced here
		intensityNode.append_child(L"multiplier").append_attribute(L"val").set_value(L"8.0");
	...
	hrLightOpen(spot3, HR_WRITE_DISCARD);
	{
		...
		lightNode.attribute(L"type").set_value(L"area");
		lightNode.attribute(L"shape").set_value(L"rect");
		lightNode.attribute(L"distribution").set_value(L"ies");           // error introduced here, ies light must have ies tag
		...
		lightNode.append_child(L"falloff_angle").append_attribute(L"val").set_value(100);
		lightNode.append_child(L"falloff_angle2").append_attribute(L"val").set_value(100); 
...
bool test92_check_xml_fail_lights()
{
	...
	hrLightOpen(sun, HR_WRITE_DISCARD);
	{
		...
		// auto sizeNode = lightNode.append_child(L"size");                        // error introduced here
	...
	hrLightOpen(sky, HR_WRITE_DISCARD);
	{
		...
		auto sunModel = lightNode.append_child(L"perezz");                                    // error inroduced here
	...
	HRLightRef sky2 = hrLightCreate(L"sky");

	hrLightOpen(sky2, HR_WRITE_DISCARD);
	{
		auto lightNode = hrLightParamNode(sky2);
